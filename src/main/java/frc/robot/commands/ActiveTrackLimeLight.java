...
public class ActiveTrackLimeLight extends Command {
  /**
   ...
   */
  public ActiveTrackLimeLight(SwerveDrive m_swerveDrive, LimeLightPose vision, Supplier<Double> x, Supplier<Double> y, Supplier<Double> rot, Supplier<Boolean> fieldRelative) {
  ...
  public void initialize() {
    Logger.recordOutput("LimeLight/ActiveTracking", true);
  }
  ...
  public void execute() {
    ...
    Optional<Double> rotSpeedOpt = calculateRotSpeed();
    ...
    if(tagIsVisible) Logger.recordOutput("LimeLight/CalculatedRotationalSpeed", rotSpeed);
  ...
  public Optional<Double> calculateRotSpeed() {
    Optional<Double> tagOffset;
    try{
      tagOffset = poseEstimator.getClosestAprilTagOffset();
    } catch (Exception e){
    ...
    Logger.recordOutput("LimeLight/TagOffset", tagOffset.get());
  ...
  public void end(boolean interrupted) {
    Logger.recordOutput("LimeLight/ActiveTracking", false);
